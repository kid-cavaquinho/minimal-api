...
public sealed class MetadataModule : IModule
{
    public void AddModule(IServiceCollection services)
    {
        ...
        {
            httpClient.BaseAddress = sp.GetRequiredService<IOptions<CoinMarketCapApiOptions>>().Value.BaseAddress;
        ...
        // services.AddHttpClient(nameof(CoinMarketCapHttpService), (sp, httpClient) =>
        // {
